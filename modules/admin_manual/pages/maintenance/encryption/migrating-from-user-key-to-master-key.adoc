...
It is possible that some or all users to see a re-synchronisation of their data from the server to the desktop client - especially for shared folders.
...
NOTE: Decryption of files by the system administrator requires the current passwords of every user!
